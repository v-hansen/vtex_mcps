...
export function tools(http: AxiosInstance): ToolDefinition[] {
  return [
    {
      name: "gift-card_create_gift_card",
      description: "Create a gift card\nPOST /giftcards",
      inputSchema: z.object({
  body: z.object({ relationName: z.string(), expiringDate: z.string(), caption: z.string(), profileId: z.string(), currencyCode: z.string().optional(), restrictedToOwner: z.boolean().optional(), multipleCredits: z.boolean().optional(), multipleRedemptions: z.boolean().optional() })
}),
  ...
  try {
    ...
    {
      name: "gift-card_get_gift_cardby_id",
  ...
  try {
    ...
    {
      name: "gift-card_search_gift_cardsfromcartdata",
      description: "List all gift cards\nPOST /giftcards/_search",
      inputSchema: z.object({
  body: z.object({ cart: z.object({ grandTotal: z.number().int(), relationName: z.string(), redemptionCode: z.string(), discounts: z.number().int(), shipping: z.number().int(), taxes: z.number().int(), items: z.array(z.object({ productId: z.string(), id: z.string(), refId: z.string(), name: z.string(), price: z.number().int(), quantity: z.number().int() })), itemsTotal: z.number().int() }), client: z.object({ id: z.string(), email: z.string(), document: z.string() }) })
}),
      handler: async (params) => {
  try {
    ...
    {
      name: "gift-card_get_gift_card_transactions",
  ...
  try {
    ...
    {
      name: "gift-card_create_gift_card_transaction",
  ...
  try {
    ...
    {
      name: "gift-card_get_gift_card_transactionby_id",
  ...
  try {
    ...
    {
      name: "gift-card_get_transaction_authorizations",
  ...
  try {
    ...
    {
      name: "gift-card_get_transaction_cancellations",
  ...
  try {
    ...
    {
      name: "gift-card_cancel_gift_card_transaction",
  ...
  try {
    ...
    {
      name: "gift-card_get_transaction_settlements",
  ...
  transactionId: z.string().describe("Transaction identification.")
      ...
      handler: async (params) => {
  try {
    const url = `/giftcards/${params.giftCardId}/transactions/${params.transactionId}/settlements`;
    const response = await http.get(url);
    return { content: [{ type: "text" as const, text: JSON.stringify(response.data, null, 2) }] };
  } catch (error: any) {
    const message = error.response?.data?.message ?? error.message ?? "Unknown error";
    ...
    {
      name: "gift-card_settle_gift_card_transaction",
